...
<body id="page-top" class="politics_version">
	...
	@endforeach
		...
		<div id="contact" class="section lb py-3" style="background-color: #640D14">
			<div class="container">
				<div class="section-title text-center">
					<h3 class="text-white">Hubungi Kami!</h3>
					<strong><p class="text-white">Jika ada pertanyaan atau butuh informasi lebih lanjut mengenai layanan kami, jangan ragu menghubungi kami melalui kontak, email, atau telepon. Tim kami siap membantu dan memberikan solusi terbaik. Terima kasih atas kepercayaan Anda!</p></strong>
				</div><!-- end title -->

...
<body id="page-top" class="politics_version">
    ...
    <div id="services" class="section lb py-3" style="background-color: #640D14">
        <div class="container">
				...
				<div class="col-md-4" >
					<div class="effect-new" >
						<div class="services-inner-box border border-white solid-3" style="background-color: #800E13">
							<h2 class="text-white">Brosur {{ $loop->iteration }}</h2>
							<a href="{{ Storage::disk('s3')->url($file_brosurs->path) }}" class="btn-primary rounded hover-effect-new text-white" style="background-color: #AD2831"><span>Download</span></a>
						</div>
					</div>
                </div><!-- end col -->
                @endforeach
